    ...
    <div className="px-4">
      <div className="w-full mx-auto">
        <div className="bg-white rounded-3xl p-8 mb-5">
          <h1 className="text-3xl font-bold mb-10">Desarrollo de panel de demostración para el inventario de libros.</h1>
          <div className="flex items-center justify-between">
            <div className="flex items-stretch">
              <div className="text-gray-400 text-xs">Miembros <br />connected</div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <div className="p-4 bg-green-100 rounded-xl">
                    <div className="font-bold text-xl text-gray-800 leading-none">Buen Dia, <br/> Cristian</div>
                    <div className="mt-5">
                ...
                <div className="p-4 bg-yellow-100 rounded-xl text-gray-800">
                  ...
                  <div className="mt-2">Tareas Terminadas</div>
                </div>
                <div className="p-4 bg-yellow-100 rounded-xl text-gray-800">
                  <div className="font-bold text-2xl leading-none">5,5</div>
                  <div className="mt-2">Horas Rastreadas</div>
                </div>
                <div className="col-span-2">
                  <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                    <div className="font-bold text-xl leading-none">Tu Plan  Diario</div>
                    <div className="mt-2">5 of 8 completadas</div>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <h2 className="text-2xl font-bold mb-4">Tus Tareas Diarias</h2>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-yellow-800 hover:underline">Blog y publicaciones sociales</a>
                ...
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-yellow-800 hover:underline">Nuevas Campañas</a>
                  <div className="text-sm text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-gray-800 inline align-middle mr-1" viewBox="0 0 16 16">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                    </svg>Nueva Revision De Campaña
                  </div>
                </div>
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                  <div className="flex justify-between">
                  ...
                  <a href="javascript:void(0)" className="font-bold hover:text-yellow-800 hover:underline">Control de calidad multiplataforma y navegador</a>
                </div>
